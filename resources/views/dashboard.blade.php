                                    ...
                                    <tr class="hover:bg-green-50 transition-colors duration-150 ease-in-out">
                                        ...
                                        <td class="border-b border-gray-200 px-4 py-3">
                                            ...
                                            <form action="{{ route('dashboard.product.delete', $product->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="bg-white border border-red-400 text-red-600 hover:bg-red-50 font-medium py-1 px-3 rounded-full text-xs flex items-center transition-all duration-150 ease-in-out">
